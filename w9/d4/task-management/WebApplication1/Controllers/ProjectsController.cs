...
public async Task<IActionResult> DeleteProject(int id)
{
    ...
    return NoContent();
       ...
       /// <summary>
/// Gets a paginated list of projects available to the authenticated user.
/// </summary>
...
/// <response code="200">Project found successfully.</response>
/// <response code="404">Project was not found or is not owned by the user.</response>
[HttpGet("{id}")]        public async Task<ActionResult<Project>> GetProject(int id)
        {
            var project = await _context.Projects.FindAsync(id);
...
///       "description": "Task management capstone project"
///     }
///
/// Example response:
///
