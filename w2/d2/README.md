...
Built two related collections (Customers and Orders) and wrote GroupBy, Join, and SelectMany queries on them.
Demonstrated deferred execution by changing the data after defining a query but before running it.
