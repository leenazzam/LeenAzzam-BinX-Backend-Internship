...
[HttpGet]
[Authorize(Roles = "Admin,Doctor,Patient")]    public async Task<ActionResult<IEnumerable<MedicationResponseDto>>> GetMedications()
    {
...
[HttpGet("{id}")]
[Authorize(Roles = "Admin,Doctor,Patient")]    public async Task<ActionResult<MedicationResponseDto>> GetMedication(int id)
    {
